...
"[project]/src/app/members-transactions/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>MembersTransactionsPage)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
const TARIF = {
    Harian: {
        "Cabang Batu Akik": 10000,
        default: 25000
    },
    Bulanan: 60000
};
function MembersTransactionsPage() {
    _s();
    const [data, setData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [isRenewal, setIsRenewal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MembersTransactionsPage.useEffect": ()=>{
            if (formData.tanggalGabung && formData.durasiBulan) {
                let startDate = isRenewal && selectedMember ? new Date(selectedMember.tanggalBerakhir) : new Date(formData.tanggalGabung);
                startDate.setMonth(startDate.getMonth() + formData.durasiBulan);
                ...
                setFormData({
                    "MembersTransactionsPage.useEffect": (prev)=>({
                            ...prev,
        ...
        formData.tanggalGabung,
        formData.durasiBulan,
        isRenewal,
        selectedMember
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MembersTransactionsPage.useEffect": ()=>{
            const interval = setInterval({
                "MembersTransactionsPage.useEffect.interval": ()=>{
                    setData({
                        "MembersTransactionsPage.useEffect.interval": (prevData)=>prevData.map({
                                "MembersTransactionsPage.useEffect.interval": (item)=>({
                                        ...item,
                                        statusAktif: new Date(item.tanggalBerakhir) >= new Date()
                                    })
                            }["MembersTransactionsPage.useEffect.interval"])
                    }["MembersTransactionsPage.useEffect.interval"]);
                }
            }["MembersTransactionsPage.useEffect.interval"], 60000);
            return ({
                "MembersTransactionsPage.useEffect": ()=>clearInterval(interval)
            })["MembersTransactionsPage.useEffect"];
        }
    }["MembersTransactionsPage.useEffect"], []);
    const calculateTarif = (cabang, jenisPembayaran)=>{
        if (jenisPembayaran === "Bulanan") return TARIF.Bulanan;
        return cabang === "Cabang Batu Akik" ? TARIF.Harian["Cabang Batu Akik"] : TARIF.Harian.default;
    };
    ...
    const handleInputChange = (e)=>{
        ...
        setFormData((prev)=>({
                ...prev,
                [name]: name === "durasiBulan" ? Number(value) : value
            }));
        if (name === "noKartu" && !isRenewal) {
            const member = data.find((m)=>m.noKartu === value);
            if (member) {
                setError("Nomor kartu sudah terdaftar. Gunakan fitur perpanjangan untuk memperbarui membership.");
            } else {
                setError("");
            }
        }
    ...
    const handleCardNumberSearch = ()=>{
        if (!formData.noKartu) {
            setError("Masukkan nomor kartu untuk melakukan perpanjangan");
            return;
        }
        const member = data.find((m)=>m.noKartu === formData.noKartu);
        if (member) {
            ...
            setFormData((prev)=>({
                    ...
                    tanggalGabung: member.tanggalBerakhir
                }));
            setError("");
        } else {
            setError("Nomor kartu tidak ditemukan");
            setSelectedMember(null);
        }
    };
    const handleSubmit = (e)=>{
        e.preventDefault();
        setError("");
        if (!formData.cabang || !formData.noKartu || !formData.nama || !formData.tanggalGabung) {
            setError("Mohon lengkapi semua field yang wajib diisi");
            return;
        }
        if (!isRenewal) {
            const isDuplicate = data.some((item)=>item.cabang === formData.cabang && item.noKartu === formData.noKartu);
            if (isDuplicate) {
                setError("Nomor kartu sudah terdaftar di cabang ini");
                return;
            }
        }
        const jumlahPembayaran = calculateTarif(formData.cabang, formData.jenisPembayaran);
        if (isRenewal && selectedMember) {
            // Update existing member's data
            setData((prevData)=>prevData.map((item)=>{
                    if (item.noKartu === selectedMember.noKartu) {
                        return {
                            ...item,
                            ...
                            riwayatPembayaran: [
                                ...
                                {
                                    tanggal: formData.tanggalPembayaran,
            ...
            const newEntry = {
                ...
                tanggalGabung: formData.tanggalGabung,
                tanggalBerakhir: formData.tanggalBerakhir,
                statusAktif: formData.statusAktif,
                jenisPembayaran: formData.jenisPembayaran,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            ...
                            children: "Data Member & Transaksi"
                        }, void 0, false, {
                            fileName: "[project]/src/app/members-transactions/page.tsx",
                            lineNumber: 265,
                            columnNumber: 11
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-gray-500 mt-2",
                            children: "Kelola data member dan transaksi pembayaran iuran"
                        }, void 0, false, {
                            fileName: "[project]/src/app/members-transactions/page.tsx",
                            lineNumber: 266,
                            columnNumber: 11
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                className: "mb-4",
                                children: isRenewal ? "Mode: Perpanjangan Member" : "Mode: Member Baru"
                            }, void 0, false, {
                                fileName: "[project]/src/app/members-transactions/page.tsx",
                                lineNumber: 272,
                                columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        isRenewal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                        ...
                                                        placeholder: "Masukkan nomor kartu untuk perpanjangan"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/members-transactions/page.tsx",
                                                        lineNumber: 292,
                                                        columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                    ...
                                                    disabled: !!(isRenewal && selectedMember),
                                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                    value: formData.statusAktif ? "aktif" : "nonaktif",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$radio$2d$group$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RadioGroup"], {
                                                    ...
                                                    onValueChange: (value)=>handleSelectChange("jenisPembayaran", value),
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Label"], {
                                                                    ...
                                                                    children: [
                                                                        "Harian (",
                                                                        formData.cabang === "Cabang Batu Akik" ? formatCurrency(TARIF.Harian["Cabang Batu Akik"]) : formatCurrency(TARIF.Harian.default),
                                                                        ")"
                                                                    ]
                                                                }, void 0, true, {
                                                                    fileName: "[project]/src/app/members-transactions/page.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    children: isRenewal ? "Perpanjang Membership" : "Simpan Data Member & Transaksi"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/members-transactions/page.tsx",
                                    lineNumber: 455,
                                    columnNumber: 13
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            ...
                            children: "Daftar Member & Transaksi"
                        }, void 0, false, {
                            fileName: "[project]/src/app/members-transactions/page.tsx",
                            lineNumber: 463,
                            columnNumber: 11
                                        ...
                                        children: [
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: `px-2 py-1 rounded-full text-xs ${item.statusAktif ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`,
                                                                children: item.statusAktif ? "Aktif" : "Non-Aktif"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/members-transactions/page.tsx",
                                                                lineNumber: 490,
                                                                columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: item.tanggalPembayaran
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/members-transactions/page.tsx",
                                                            lineNumber: 499,
                                                            columnNumber: 21
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: formatCurrency(item.jumlahPembayaran)
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/members-transactions/page.tsx",
                                                            lineNumber: 500,
                                                            columnNumber: 21
                                            ...
                                            data.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                    ...
                                                    children: "Belum ada data member atau transaksi"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/members-transactions/page.tsx",
                                                    lineNumber: 505,
                                                    columnNumber: 21
...
_s(MembersTransactionsPage, "IXX3QJAoIWPXmbhSDXitFMfPJZM=");
_c = MembersTransactionsPage;
var _c;
__turbopack_context__.k.register(_c, "MembersTransactionsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_20f76191._.js.map